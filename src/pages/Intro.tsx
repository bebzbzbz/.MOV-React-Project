    ...
    return ( 
        <>
            ...
            <section className="flex flex-col md:flex-row md:items-center h-screen justify-between">
                ...
                <img className="w-2/3 md:w-5/6  rounded-xl" src="../../public/images/Sariri.png" alt="Screenshot einer Seite" />
                </div>
                <div className="absolute z-20 rotate-4 -right-25 md:right-10 top-25 lg:right-50">
                <img className="w-2/3 md:w-full rounded-xl" src="../../public/images/Cat.png" alt="Screenshot einer Seite" />
                </div>
                </div>
